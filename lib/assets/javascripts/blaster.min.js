            ...
            _displayAlignments: function(e, d) {
                ...
                function v(e, t) {
                    ...
                    for (var f = 0; f < e.length; f++) {
                        ...
                        H.innerHTML = e[f].hsp[0].identities + "%", y.appendChild(v), y.appendChild(C), y.appendChild(E), y.appendChild(x), y.appendChild(T), y.appendChild(H), g.appendChild(y)
                    }
