...
! function(A, e) {
    ...
    function w(A, e, t, r, B) {
        ...
        if (i === M && -1 !== [X, P, x].indexOf(c) || -1 !== [X, P, x].indexOf(i) && c === S) return Y;
        if (-1 !== Z.indexOf(i) && -1 !== AA.indexOf(c) || -1 !== AA.indexOf(i) && -1 !== Z.indexOf(c)) return Y;
        if (-1 !== [M, S].indexOf(i) && (c === D || -1 !== [O, f].indexOf(c) && e[1 + o] === D) || -1 !== [O, f].indexOf(i) && c === D || i === D && -1 !== [D, y, v].indexOf(c)) return Y;
        ...
        if (-1 !== tA.indexOf(i) && -1 !== [R, S].indexOf(c) || -1 !== tA.indexOf(c) && i === M) return Y;
    ...
    function u(t, A) {
        ...
        var e = function(A, B) {
                ...
                return A.forEach(function(A, e) {
                    var t = q.get(A);
                    if (50 < t ? (o.push(!0), t -= 50) : o.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(B) && -1 !== [8208, 8211, 12316, 12448].indexOf(A)) return s.push(e), n.push(16);
                    if (4 !== t && 11 !== t) return s.push(e), 31 === t ? n.push("strict" === B ? L : X) : t === W ? n.push(_) : 29 === t ? n.push(_) : 43 === t ? 131072 <= A && A <= 196605 || 196608 <= A && A <= 262141 ? n.push(X) : n.push(_) : void n.push(t);
    ...
    var a, U, E, F, h, H = 10,
        ...
        q = (a = function(A) {
            ...
            return t
        }(a) : new Uint16Array(a), F = s(E, 12, U[4] / 2), h = 2 === U[5] ? s(E, (24 + U[4]) / 2) : function(A, e, t) {
            return A.slice ? A.slice(e, t) : new Uint32Array(Array.prototype.slice.call(A, e, t))
        }(U, Math.ceil((24 + U[4]) / 4)), new o(U[0], U[1], U[2], U[3], F, h)),
        Z = [_, 36],
        j = [1, 2, 3, 5],
        $ = [H, 8],
        AA = [M, S],
        ...
        tA = [J, G, k, V, z],
        rA = [f, d],
        BA = (nA.prototype.slice = function() {
        ...
        MA = (yA.prototype.write = function(A) {
            ...
            switch (A) {
                ...
                case 64:
                    ...
                    if (UA(c, Q, w)) return n = this.consumeName(), {
            ...
            for (var e = "", t = 0;;) {
                ...
                if (92 === r) {
                    var B = this._value[t + 1]; - 1 !== B && void 0 !== B && (10 === B ? (e += this.consumeStringSlice(t), t = -1, this._value.shift()) : uA(r, B) && (e += this.consumeStringSlice(t), e += l(this.consumeEscapedCodePoint()), t = -1))
                }
                t++
            }
    ...
    var ye = (_e.prototype.addImage = function(A) {
        ...
        return B(this, void 0, void 0, function() {
            ...
            return b(this, function(A) {
                switch (A.label) {
                    case 0:
                        return e = be.isSameOrigin(s), r = !ke(s) && !0 === this._options.useCORS && ve.SUPPORT_CORS_IMAGES && !e, t = !ke(s) && !e && "string" == typeof this._options.proxy && ve.SUPPORT_CORS_XHR && !r, e || !1 !== this._options.allowTaint || ke(s) || t || r ? (B = s, t ? [4, this.proxy(B)] : [3, 2]) : [2];
                    case 1:
                        B = A.sent(), A.label = 2;
                    case 2:
                        return De.getInstance(this.id).debug("Added image " + s.substring(0, 256)), [4, new Promise(function(A, e) {
                            ...
                            t.onload = function() {
                                return A(t)
                            }, t.onerror = e, (We(B) || r) && (t.crossOrigin = "anonymous"), t.src = B, !0 === t.complete && setTimeout(function() {
                                return A(t)
    ...
    var cB, QB = function(A) {
            ...
            switch (A.type) {
                ...
                case Ce.TYPE_VALUE:
                    switch (A.format) {
                        ...
                        case "image":
                            return ot(B.parseComponentValue());
                        case "length":
        ...
        UB = function(A) {
            this.styles = new iB(window.getComputedStyle(A, null)), this.textNodes = [], this.elements = [], null !== this.styles.transform && un(A) && (A.style.transform = "none"), this.bounds = T(A), this.flags = 0
        },
        lB = function(A, e) {
        ...
        FB = function(A, e) {
            for (var t, r = function(A, e) {
                ...
                }), B = []; !(t = r.next()).done;) t.value && B.push(t.value.slice());
            return B
        },
        hB = function(A, e) {
    ...
    function LB(A) {
        var e = mB.call(this, A) || this,
            t = new XMLSerializer;
        return e.svg = "data:image/svg+xml," + encodeURIComponent(t.serializeToString(A)), e.intrinsicWidth = A.width.baseVal.value, e.intrinsicHeight = A.height.baseVal.value, be.getInstance().addImage(e.svg), e
    }
        ...
        Pn = (xn.prototype.toIFrame = function(A, e) {
            ...
            var B = A.defaultView.pageXOffset,
                ...
                i = Jn(r).then(function() {
                    t.scrolledElements.forEach(Yn), s && (s.scrollTo(e.left, e.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || s.scrollY === e.top && s.scrollX === e.left || (o.documentElement.style.top = -e.top + "px", o.documentElement.style.left = -e.left + "px", o.documentElement.style.position = "absolute"));
    ...
    var Vn, zn, Xn = function(A, e) {
            ...
            return t.className = "html2canvas-container", t.style.visibility = "hidden", t.style.position = "fixed", t.style.left = "-10000px", t.style.top = "0px", t.style.border = "0", t.width = e.width.toString(), t.height = e.height.toString(), t.scrolling = "no", t.setAttribute(_n, "true"), A.body.appendChild(t), t
        },
        Jn = function(B) {
    ...
    var ps = function(c, Q, w, u) {
        ...
        Ks = function(A, e, t, r) {
            var B = [];
            return os(A) ? B.push(A.subdivide(.5, !1)) : B.push(A), os(t) ? B.push(t.subdivide(.5, !0)) : B.push(t), os(r) ? B.push(r.subdivide(.5, !0).reverse()) : B.push(r), os(e) ? B.push(e.subdivide(.5, !1).reverse()) : B.push(e), B
        },
        Is = function(A, e, t) {
            var r = e[0],
                B = e[1],
    ...
    var vs = (Ds.prototype.applyEffects = function(A, e) {
            ...
            return b(this, function(A) {
                switch (A.label) {
                    ...
                    case 19:
                        ...
                        }(r.lineHeight, r.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new lB(l.listValue, U), r.letterSpacing), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"), A.label = 20;
                    case 20:
                        return [2]
                }
            })
        ...
        return B(this, void 0, void 0, function() {
            ...
            return b(this, function(A) {
                switch (A.label) {
                    case 0:
                        v = S.styles.backgroundImage.length - 1, e = function(e) {
                            ...
                            return b(this, function(A) {
                                switch (A.label) {
                                    ...
                                    case 4:
                                        return t && (B = Hs(S, v, [t.width, t.height, t.width / t.height]), g = B[0], f = B[1], p = B[2], h = B[3], H = B[4], l = D.ctx.createPattern(D.resizeImage(t, h, H), "repeat"), D.renderRepeat(g, l, f, p)), [3, 6];
                                    case 5:
                                        ! function(A) {
                                            return A.type === xe.LINEAR_GRADIENT
                                        }(e) ? function(A) {
                                            return A.type === xe.RADIAL_GRADIENT
                                        }(e) && (C = Hs(S, v, [null, null, null]), g = C[0], E = C[1], F = C[2], h = C[3], H = C[4], d = 0 === e.position.length ? [oe] : e.position, f = ae(d[0], h), p = ae(d[d.length - 1], H), N = function(A, e, t, r, B) {
                                            var n = 0,
                                                s = 0;
                                            switch (A.size) {
                                        ...
                                        }), D.path(g), D.ctx.fillStyle = T, K !== I ? (m = S.bounds.left + .5 * S.bounds.width, R = S.bounds.top + .5 * S.bounds.height, O = 1 / (L = I / K), D.ctx.save(), D.ctx.translate(m, R), D.ctx.transform(1, 0, 0, L, 0, 0), D.ctx.translate(-m, -R), D.ctx.fillRect(E, O * (F - R) + R, h, H * O), D.ctx.restore()) : D.ctx.fill())) : (n = Hs(S, v, [null, null, null]), g = n[0], f = n[1], p = n[2], h = n[3], H = n[4], s = pe(e.angle, h, H), o = s[0], i = s[1], a = s[2], c = s[3], Q = s[4], (w = document.createElement("canvas")).width = h, w.height = H, u = w.getContext("2d"), U = u.createLinearGradient(i, c, a, Q), fe(e.stops, o).forEach(function(A) {
                                            return U.addColorStop(A.stop, te(A.color))
                                        }), u.fillStyle = U, u.fillRect(0, 0, h, H), l = D.ctx.createPattern(w, "repeat"), D.renderRepeat(g, l, f, p)), A.label = 6;
                                    case 6:
                                        return v--, [2]
                                }
                            })
            ...
            return b(this, function(A) {
                switch (A.label) {
                    case 0:
                        ...
                        }], B = bs(Ts(e.backgroundClip, 0), c.curves), t || e.boxShadow.length ? (this.ctx.save(), this.path(B), this.ctx.clip(), ee(e.backgroundColor) || (this.ctx.fillStyle = te(e.backgroundColor), this.ctx.fill()), [4, this.renderBackgroundImage(c.container)]) : [3, 2];
                    case 1:
                ...
                return b(this, function(A) {
                    switch (A.label) {
                        case 0:
                            ...
                            return r = (Math.round(1e3 * Math.random()) + Date.now()).toString(16), B = En(p) || function(A) {
                            ...
                            }(e) : T(p), n = B.width, s = B.height, o = B.left, i = B.top, a = K({}, {
                                allowTaint: !1,
                                imageTimeout: 15e3,
                                proxy: void 0,
                                useCORS: !1
                                ...
                                height: Math.ceil(s),
                                id: r
                            }, Q = K({}, c, a, N), w = new I(Q.scrollX, Q.scrollY, Q.windowWidth, Q.windowHeight), De.create(r), De.getInstance(r).debug("Starting document clone"), u = new Pn(p, {
                                id: r,
                                onclone: Q.onclone,
                        ...
                        case 1:
                            return l = A.sent(), C = e.documentElement ? Ps(getComputedStyle(e.documentElement).backgroundColor) : He.TRANSPARENT, g = e.body ? Ps(getComputedStyle(e.body).backgroundColor) : He.TRANSPARENT, E = N.backgroundColor, F = "string" == typeof E ? Ps(E) : 4294967295, h = p === e.documentElement ? ee(C) ? ee(g) ? F : g : C : F, H = {
                                id: r,
                                cache: Q.cache,
                                backgroundColor: h,
                                scale: Q.scale,
                        ...
                        case 2:
                            return d = A.sent(), [3, 5];
                        case 3:
                            return De.getInstance(r).debug("Document cloned, using computed rendering"), be.attachInstance(Q.cache), De.getInstance(r).debug("Starting DOM parsing"), f = on(U), be.detachInstance(), h === f.styles.backgroundColor && (f.styles.backgroundColor = He.TRANSPARENT), De.getInstance(r).debug("Starting renderer"), [4, new vs(H).render(f)];
                        case 4:
                            d = A.sent(), A.label = 5;
                        case 5:
                            return !0 === Q.removeContainer && (zs(l) || De.getInstance(r).error("Cannot detach cloned iframe as it is not in the DOM anymore")), De.getInstance(r).debug("Finished rendering"), De.destroy(r), be.destroy(r), [2, d]
                    }
                })
            })
        },
